...
try {
    if (!fs.existsSync(projectDir)) {
        ...
        // Atualiza o arquivo de portfólio no diretório correto
        const portfolioFile = path.join(__dirname.includes('OneDrive') ? "C:\\Users\\thmed\\OneDrive\\Documentos\\GitHub\\portifolio" : __dirname, 'portfolio.html');
        updatePortfolio(projectName, portfolioFile);
