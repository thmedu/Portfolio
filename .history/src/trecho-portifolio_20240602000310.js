  ...
  fs.access(portfolioPath, fs.constants.F_OK, (err) => {
    if (err) {
      ...
      fs.access(portfolioPath, fs.constants.F_OK, (err) => {
        ...
        atualizarPortfolio(portfolioPath, projectName, Description, Tecnologia, Site);
      });
    } else {
...
// Função para atualizar o portfólio com Description de um novo projeto
function atualizarPortfolio(portfolioPath, projectName, Description, Tecnologia, Site) {
