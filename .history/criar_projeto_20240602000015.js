...
const updatePortfolio = require('./src/atualizar_portfolio'); // Importação do módulo updatePortfolio
...
try {
    ...
    if (!fs.existsSync(projectDir)) {
        ...
        // Lê o conteúdo do arquivo conteudo-portifolio.html
        ...
        // Lê o conteúdo do arquivo conteudo-coluna.html
